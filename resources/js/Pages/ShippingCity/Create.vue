...
const saveShippingCity = () => {
    form.post(route('shipping-cities.store'), {
        onSuccess: () => {
        },
        onError: (error) => {
        },
                                ...
                                <VCol cols="8" offset="2">
                                    <div>
                                        ...
                                        <div class="my-5 float-right">
                                            ...
                                            <PrimaryButton @click="saveShippingCity" class="mx-2">Save</PrimaryButton>
                                        </div>
                                    </div>
                                </VCol>
                            </VRow>
